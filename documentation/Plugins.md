...
See the [Developing Plugins](./Developing_Plugins.md) documentation to learn more about creating your own plugin.
...
Show a list of all installed plugins: `paperpi --list_plugins`

### Show Plugin Documentation

Display plugin documentation for a single plugin: `paperpi --plugin_info plugin_name`

### Add Default Configuration

Add the default configuration for a particular plugin the user or system configuration file: `paperpi --add_config plugin_name user|daemon`

*NB:* It is important to check the configuration file after running this command; some plugins require additional configuration

## Configuration File

### [Main] section

General configuration for PaperPi. See [README.md](../README.md/#setup) for more information about the main section.
